...
export default function Home() {
  return (
    <main className="min-h-screen">
      ...
      <DynamicContactForm location="India" domain="indianturban.com" />
      <GallerySection />
      <DynamicServicesSection location="India" domain="indianturban.com" />
      <DynamicFooter location="India" domain="indianturban.com" />
      <WhatsAppFloat />
    </main>
  )
}
